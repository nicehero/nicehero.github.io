...
THREE.SSAOPass = function ( scene, camera, width, height ) {
	...
	this.normalMaterial = new THREE.MeshNormalMaterial({skinning: true});
	//this.normalMaterial = new THREE.MeshToonMaterial( { color: 0x888888, gradientMap: threeTone } );
	this.normalMaterial.blending = THREE.NoBlending;
	this.normalMaterial.skinning = true;
	this.normalMaterial.morphTargets = true;
	this.normalMaterial.morphNormals = true;
/*
...
THREE.SSAOPass.prototype = Object.assign( Object.create( THREE.Pass.prototype ), {
	...
	renderOverride: function ( renderer, overrideMaterial, renderTarget, clearColor, clearAlpha ) {
		...
		renderer.isRenderToNormal = true;
		renderer.render( this.scene, this.camera );
		renderer.isRenderToNormal = false;
		//this.scene.overrideMaterial = null;

		//this.fsQuad.material = overrideMaterial;
		//this.fsQuad.render( renderer );
		// restore original state
